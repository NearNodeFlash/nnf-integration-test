...
if [[ -x ./upgrade-tester.sh ]]; then
    UPGRADE_TESTER=$PWD/upgrade-tester.sh
elif [[ -x ./upgrade-tester/upgrade-tester.sh ]]; then
    UPGRADE_TESTER=$PWD/upgrade-tester/upgrade-tester.sh
else
    do_fail "Unable to find upgrade-tester.sh."
fi
